...
public class BlockPlanterSand extends Block implements ITileEntityProvider {

	public static final PropertyInteger VARIANT = PropertyInteger.create("variant", 0, 15);

	public BlockPlanterSand() {
		super(Material.SAND);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if (!playerIn.capabilities.allowEdit)
		{
			...
			if (enumUsed > 0) {
				...
				if (te !=  null) {
					if (te instanceof BlockPlanterSand.TileEntityPlanter1Sand) {
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new BlockPlanterSand.TileEntityPlanter1Sand();
	}
