...
import net.prehistoricnaturedeco.block.base.util;
...
public class BlockRopeBarrier extends net.prehistoricnaturedeco.ElementsPrehistoricNatureDecoMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:rope_barrier")
	public static final Block block = null;
	public BlockRopeBarrier(net.prehistoricnaturedeco.ElementsPrehistoricNatureDecoMod instance) {
		super(instance, LepidodendronSorter.rope_barrier);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockRopeBarrier.BlockCustom().setRegistryName("lepidodendron:rope_barrier"));
